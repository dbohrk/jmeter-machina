...
# JMeter Thread Groups that do not change the number of Markings. And require identification strings in the configuration file
threadGroups=( "updateMarkingStatic" "fetchMarkingStatic" )
